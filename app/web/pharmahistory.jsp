<%-- 
    Document   : pharmahistory
    Created on : 12 Dec, 2018, 8:09:52 PM
            ...
            <div id="fg_box" class="box box-info box-solid" style="margin-bottom:0px">
                ...
                <div class="box-body">
                    <form action="AnnouncementServlet" method="POST" class="row">    
                        <input type="hidden" name="viewid" value="pharmacy.jsp">
...
<!--Announcement Box End-->
        ...
        <div class="col-xs-12 col-md-8 content"> 
            <div id="fg_box" class="box box-info box-solid" style="margin-bottom:0px">
                ...
                <div class="box-header with-border">
                    <h3 class="box-title">Today's Medicine History</h3>
                        ...
                        <table class="table">
                            ...
                            <tbody>
                                ...
                                <%
                                    ...
                                    ArrayList<Order> orderList = orderDAO.getTodaysProcessedOrders();
                                ...
                                %>
                                            ...
                                            <tr class="issued<%=counter%>">
                                                ...
                                                <td><%=firstOrder.getDate()%></td>
                                                <td><%=firstOrder.getStatus()%></td>
                                            </tr>
                                    <%
